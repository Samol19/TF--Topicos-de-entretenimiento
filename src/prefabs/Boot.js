...
class BootPrefab extends Phaser.Physics.Arcade.Sprite {
    constructor(scene, texture) {
        ...
        const startY = Phaser.Math.Between(229, scene.game.config.height - 20); // Posición aleatoria en Y
